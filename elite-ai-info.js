...
(() => {
  window.ELITE_AI_EFFECT_INFO_V2 = Object.freeze({
    ...
    "2004": Object.freeze({ name: "关山急", description: "我方卡牌战力不能低于2。\r\n敌方卡牌战力不能高于5。", level: "intermediate", levelLabel: "中级" }),
    "2005": Object.freeze({ name: "鸿门宴", description: "敌方卡牌放置时，战力+1。\r\n回合开始时，非我方卡牌战力-1。", level: "intermediate", levelLabel: "中级" }),
    "2006": Object.freeze({ name: "丹书诏", description: "敌方抽卡时，我方抽一张卡牌。若手牌已满则随机一张我方卡牌战力+1。", level: "intermediate", levelLabel: "中级" }),
    ...
    "3006": Object.freeze({ name: "破釜沉舟", description: "我方卡牌被摧毁后，会是其他我方卡牌战力+1。", level: "advanced", levelLabel: "高级" }),
